/**
 * @file partC.c
 * @brief This file includes the implementation for study buddy project
 */
...
/**
 * @brief Setups the board for study buddy
 *
 * @param None
 * @return n/a
 * @details The setup involves the creation of required queues to send data from one task to another, task initialization, 
 * and digital pin initializations for servo motor, ultrasonic sensor, joystick and LCD. 
 */
void setup() {
  Serial.begin(921600);
...
/**
 * @brief Handles user input for setting a timer.
 *
 * @param pvParameters Pointer to task parameters.
 * @return n/a
 * @details This task continuously monitors user input from a joystick. It communicates the timer value to other tasks for 
 * display and countdown purposes.
 */
void inputTime(void *pvParameters) {
...
/**
 * @brief measure distance to any object detected by the ultrasonic sensor
 *
 * @param pvParameters Pointer to task parameters.
 * @return n/a
 * @details This task continuously measure distance to any object detected by the ultrasonic sensor and send a data 
 * to other task if the distance reaches a certain point.
 */
void measureDist(void *pvParameters) {
...
/**
 * @brief servo motor act as a hand and wave.
 *
 * @param pvParameters Pointer to task parameters.
 * @return n/a
 * @details servo motor wave when receiving a signal from measureDist()
 */
void waveHand(void *pvParameters) {
...
/**
 * @brief display user input for setting a timer.
 *
 * @param pvParameters Pointer to task parameters.
 * @return n/a
 * @details LCD display the time from inputTime()
 */
void displayLCD(void *pvParameters) {
  int minute = 0;
  for (;;) {
...
/**
 * @brief display countdown timer after the switch is pressed.
 *
 * @param pvParameters Pointer to task parameters.
 * @return n/a
 * @details start countdown after the switch is pressed and stop after it reaches 00:00.
 */
void displayCountdown(void *pvParameters) {
 ...
 * @param pvParameters Pointer to task parameters.
 * @return n/a
 * @details display a motivational quote in LCD when receiving a signal from measureDist()
 */
void displayQuote(void *pvParameters) {
  char* printingQuote;
